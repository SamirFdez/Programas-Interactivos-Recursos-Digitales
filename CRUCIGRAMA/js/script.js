...
$('#ayuda').click( function() {
  swal( "¿Cómo jugar?", 
  "Un crucigrama es un pasatiempo que consiste en escribir en una plantilla una serie de palabras en orden vertical y horizontal que se cruzan entre sí. En la plantilla se proponen dos listas de definiciones, una horizontal y otra vertical. Igualmente la plantilla está dividida en casillas blancas que corresponden a letras individuales y negras que sirven para separar palabras."
  )});
